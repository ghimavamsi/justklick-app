...
export function AnimatedIcon() {
  return (
    <View className="justify-center items-center w-[128px] h-[128px] z-[100]">
      ...
      <Animated.View entering={keyframe.duration(DURATION)} className="rounded-[40px] w-[128px] h-[128px] absolute" style={{ experimental_backgroundImage: `linear-gradient(180deg, #3C9FFE, #0274DF)` } as any} />
