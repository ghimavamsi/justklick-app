  ...
  return (
    <View className="flex-1 items-center justify-center bg-background p-6">
      <View className="w-full max-w-sm rounded-2xl bg-card p-8 shadow-lg">
        <Text className="mb-2 text-center text-3xl font-bold text-foreground">Welcome Back</Text>
        <Text className="mb-8 text-center text-sm text-muted-foreground">Log in to your account to continue</Text>
        ...
        >
          <Text className="text-base font-semibold text-primary-foreground">Log In</Text>
        </TouchableOpacity>
        ...
        >
          <Text className="text-sm font-medium text-primary">Don't have an account? Sign up</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
